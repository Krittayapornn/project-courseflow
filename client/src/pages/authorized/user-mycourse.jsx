  ...
  return (
    <>
      <div className="realative -z-40">
        ...
        <div className="absolute top-[9rem] left-[-0.8rem] md:left-8">
          <svg
            width="27"
            height="27"
            viewBox="0 0 27 27"
        ...
        <div className="absolute top-[100rem]  md:left-[23rem] md:top-[12rem]">
          <svg
            width="23"
            height="23"
            viewBox="0 0 23 23"
        ...
        <div className="z-10 shadow-shadow2 fixed top-0 w-full flex justify-between items-center bg-white sm:px-8 px-4 py-2 md:py-4 border-b border-b-[#e6ebf4]">
          <Link
            to="/"
